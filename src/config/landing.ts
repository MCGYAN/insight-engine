/** Public-facing landing page copy — no internal research terminology */
...
export const landingConfig = {
  ...
  trust: {
    ...
    subtitle: 'We built this assessment the way a trusted financial service should.',
    items: [
      {
        label: '1 minute assessment',
        description: 'Short, focused, and respectful of your time.',
      },
      {
        label: 'Confidential responses',
        description: 'Your answers are never shared or sold.',
      },
      {
        label: 'No wallet passwords or private keys',
        description: 'We never ask for access to your accounts or funds.',
      },
      {
        label: 'No personal financial details',
        description: 'Bank accounts, balances, and transaction history stay private.',
      },
    ],
  },
  guidePreview: {
  ...
  success: {
    ...
    community: {
      ...
      description:
        'Receive future crypto insights, research findings, and opportunities to test new financial products before everyone else.',
      cta: 'Join WhatsApp Community',
    },
    privacy: {
      title: 'Your privacy matters.',
      body: 'Joining the WhatsApp community is completely optional. Your assessment responses remain confidential.',
    },
  },
}
